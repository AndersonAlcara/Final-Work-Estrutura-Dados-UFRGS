    ...
    else
    {
        ...
        else // arquivo de lexico OK
        {
            ...
            // abertura txt-entrada, OK.
                ...
                // criando arquivo saida para escrita, nao precisa existir previamente, ele cria com a nome armazenado na string em argv
                ...
                else
                {
                    ...
                    // podemos criar a funcao destroiAvl();

                    a = destroiAVL(a);
                    if(a!=NULL) printf("erro ao destruir AVL!");
                    ...
                    // cada inicio de linha inserimos esccore:nota, nota esta que está armazenada na lista, em respectiva ordem.
                        ...
                        // após terminar o txt devemos fecha-lo
                        fclose(txt_saida);
                        fclose(txt_entrada);
